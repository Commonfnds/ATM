...
public class ATMServiceImplTest {
	...
	public void testDeposit_2() {
		...
		List<Note> depositedNotes_2 = Arrays.asList(new Note(Denomination.TWENTY, 3), new Note(Denomination.FIVE, 18),
				new Note(Denomination.ONE, 4));
	...
	public void testWithdraw_1() {
		List<Note> depositedNotes = Arrays.asList(new Note(Denomination.TWENTY, 3), new Note(Denomination.TEN, 8),
				new Note(Denomination.FIVE, 38), new Note(Denomination.ONE, 4));
		atmService.deposit(depositedNotes);
	...
	public void testWithdraw_2() {
		List<Note> depositedNotes = Arrays.asList(new Note(Denomination.TEN, 7), new Note(Denomination.FIVE, 37),
				new Note(Denomination.ONE, 4));
		atmService.deposit(depositedNotes);
